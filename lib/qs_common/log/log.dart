...
class Log {
  ...
  d([
    ...
    if (isDebug) {
      printWrapped(
          "$TAG ${value1 ?? ""} ${value2 ?? ""} ${value3 ?? ""} ${value4 ?? ""} ${value5 ?? ""} ${value6 ?? ""} ${value7 ?? ""} ${value8 ?? ""}",
          true);
    }
  }
  ...
  dTAG(
    ...
    if (isDebug) {
      printWrapped(
          "${tag ?? TAG} ${value1 ?? ""} ${value2 ?? ""} ${value3 ?? ""} ${value4 ?? ""} ${value5 ?? ""} ${value6 ?? ""} ${value7 ?? ""} ${value8 ?? ""}",
          true);
    }
  }

  i2(dynamic value, dynamic value1, {tag}) {
    print("${tag ?? TAG}  $value  $value1");
  }

  i3(dynamic value, dynamic value2, dynamic value3, {tag}) {
  ...
  i1TAG(String tag, dynamic value) {
    print("${tag ?? TAG}  $value");
  }
  ...
  i3TAG(String tag, dynamic value, dynamic value2, dynamic value3) {
    print("${tag ?? TAG}  $value  $value2  $value3");
  }
  ...
  void printWrapped(String text, bool line) {
    if (line) {
